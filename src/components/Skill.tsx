...
const Skills = () => {
  return (
    <section
      id="skills"
      className="bg-gradient-to-r from-purple-600 to-blue-500 py-20 px-6"
    >
      <div className="text-center mb-16">
        ...
        <p className="text-lg md:text-xl leading-relaxed mb-8 text-gray-300">
          Proficient in building responsive and visually appealing websites
          using HTML, CSS, JavaScript, and React. Currently expanding expertise
          by studying Next.js.
        </p>
      </div>
